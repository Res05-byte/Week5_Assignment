...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5sumsq_sum_sq(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n); /* proto */
...
#define __pyx_n_u_sum_sq __pyx_string_tab[17]
...
/* Python wrapper */
static PyObject *__pyx_pw_5sumsq_1sum_sq(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_5sumsq_1sum_sq = {"sum_sq", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5sumsq_1sum_sq, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5sumsq_1sum_sq(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("sum_sq (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "sum_sq", 0) < (0)) __PYX_ERR(0, 2, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("sum_sq", 1, 1, 1, i); __PYX_ERR(0, 2, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("sum_sq", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("sumsq.sum_sq", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5sumsq_sum_sq(__pyx_self, __pyx_v_n);
...
static PyObject *__pyx_pf_5sumsq_sum_sq(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  int __pyx_v_i;
  int __pyx_v_total;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("sum_sq", 0);
...
*/
  ...
  __pyx_t_4 = __Pyx_PyLong_From_int(__pyx_v_total); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 *     cdef int total = 0
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_5sumsq_1sum_sq, 0, __pyx_mstate_global->__pyx_n_u_sum_sq, NULL, __pyx_mstate_global->__pyx_n_u_sumsq, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_sum_sq, __pyx_t_2) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{9},{20},{18},{18},{8},{1},{13},{5},{8},{10},{1},{8},{3},{12},{12},{10},{6},{5},{8},{5},{6},{40}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (193 bytes) */
const char* const cstring = "x\332=\216MjBA\020\204UT\"\256\024r\000/ $\036\300\215kQ\301u1\216-\014\231\237\367\354\036\361\355\\\276\345,=\232K\217\220#\330$!\275\370\250\242\n\272\226\234\003\327\363\252\271\002\033\305\246Y9+X\323Uvt2\334D\353\322\334\246s\312\342\"\261\365J\270\0109\033K\007c\277\200S\216\026pp\214\377\242\023\n\014\004\243U\275\220\216\331\023\240&\232\240\242J\025Pg\343\177-\300$\177\221\252\243\276\316^t\033\270\376Y\010\010\261(\223\030\1771>\023\337\272\317\376{\331~\017;\203Q;h\367eV\026\345p\357\335g\217\267I\231\226\317\262}\366\307\355\307\013\251UY\211";
...
const char* const bytes = "?sumsq.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func__i_is_coroutineitems__main____module__n__name__pop__qualname____set_name__setdefaultsum_sqsumsq__test__totalvalues\200\001\340\004\025\220Q\360\006\000\005\t\210\005\210U\220!\2203\220b\230\002\230!\330\010\021\220\022\2202\220Q\340\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_sumsq_pyx, __pyx_mstate->__pyx_n_u_sum_sq, __pyx_mstate->__pyx_kp_b_iso88591_Q_U_3b_2Q_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
