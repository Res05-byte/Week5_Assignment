...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_7reverse_rev_str(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_s); /* proto */
...
#define __pyx_kp_u_reverse_pyx __pyx_string_tab[2]
...
#define __pyx_n_u_rev_str __pyx_string_tab[17]
#define __pyx_n_u_reverse __pyx_string_tab[18]
...
#define __pyx_kp_b_iso88591_AQ_A_U_2Rt4q_7_1AQ_2U_1 __pyx_string_tab[24]
...
/* Python wrapper */
static PyObject *__pyx_pw_7reverse_1rev_str(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_7reverse_1rev_str = {"rev_str", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_7reverse_1rev_str, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7reverse_1rev_str(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("rev_str (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "rev_str", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("rev_str", 1, 1, 1, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("rev_str", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 1, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("reverse.rev_str", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7reverse_rev_str(__pyx_self, __pyx_v_s);
...
static PyObject *__pyx_pf_7reverse_rev_str(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_s) {
  int __pyx_v_i;
  int __pyx_v_n;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("rev_str", 0);
 ...
 * 
*/
  __pyx_t_1 = PyObject_Length(__pyx_v_s); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_v_n = __pyx_t_1;
 ...
 *     return "".join(out)
*/
    __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_s, __pyx_v_i, int, 1, __Pyx_PyLong_From_int, 0, 1, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = __Pyx_PyList_Append(__pyx_v_out, __pyx_t_2); if (unlikely(__pyx_t_4 == ((int)-1))) __PYX_ERR(0, 8, __pyx_L1_error)
...
*/
  ...
  __pyx_t_2 = PyUnicode_Join(__pyx_mstate_global->__pyx_kp_u_, __pyx_v_out); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
 ...
 *     cdef int n = len(s)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_7reverse_1rev_str, 0, __pyx_mstate_global->__pyx_n_u_rev_str, NULL, __pyx_mstate_global->__pyx_n_u_reverse, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_rev_str, __pyx_t_2) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{0},{1},{11},{20},{18},{18},{8},{1},{13},{5},{8},{10},{1},{8},{3},{3},{12},{7},{7},{1},{12},{10},{8},{6},{61}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (208 bytes) */
const char* const cstring = "x\332=\216Aj\002A\020E\023\030C\202\253\220\\\300\013\010\212\220e\020\262\016Fp\375i\333\022\232\364t\217]\325\342\354\262\234e/=\232K\217\340\021\254\250X\213\317\257_\257\340\177&\332Rb\0326\355\016\230\251\314\332/g\005\337\264\2239\255\r\267\301\2728\2641\305,.\020[\257\n\027 \311XZ\032\373\013\254s\260\200\203c\334A'T3P\033Eu\352\270\312\236\000]\202\251\325(\325\304\006\330d\343\257\211V\001K\2725\322_&\271\301\352VZ&{\001\204Xuk|&\376{<V\257\345\255L\313\317\241z/\323\323\323C\357\245\353u\2132(\3432/\262\237\3547\207\347~\367\241\301\350\037;V\375n|\271\217\316\014}c\261";
...
const char* const bytes = "?reverse.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func__i_is_coroutineitems__main____module__n__name__outpop__qualname__rev_strreverses__set_name__setdefault__test__values\200\001\340\004\021\220\023\220A\220Q\330\004\024\220A\360\006\000\005\t\210\005\210U\220!\2202\220R\220t\2304\230q\330\010\013\2107\220!\2201\220A\220Q\340\004\013\2102\210U\220!\2201";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_s, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_n, __pyx_mstate->__pyx_n_u_out};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_reverse_pyx, __pyx_mstate->__pyx_n_u_rev_str, __pyx_mstate->__pyx_kp_b_iso88591_AQ_A_U_2Rt4q_7_1AQ_2U_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
